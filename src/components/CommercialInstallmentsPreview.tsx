          ...
          <div className="grid min-h-0 flex-1 grid-cols-[minmax(0,1fr)_minmax(0,1fr)] auto-rows-fr gap-2 max-[430px]:gap-1.5">
            {installmentOptions.map((option) => (
              <div
                ...
                className="flex min-h-0 min-w-0 flex-col justify-between overflow-hidden rounded-2xl border border-slate-200/90 bg-white px-2.5 py-2.5 text-slate-900 shadow-[0_9px_18px_rgba(15,23,42,0.06)] max-[430px]:rounded-xl max-[430px]:px-2 max-[430px]:py-1.5"
              >
                <p className="w-fit rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-black leading-none text-blue-700 ring-1 ring-blue-100 max-[430px]:px-1.5 max-[430px]:text-[8px]">
                  {option.installments}x
                </p>
                <p className="mt-1 min-w-0 whitespace-nowrap text-[14px] font-black leading-none tabular-nums text-slate-950 max-[430px]:text-[10px]">
